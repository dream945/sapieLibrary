...
- DAISY図書の閲覧（ブラウザで見出しナビゲーション可能）
- 既存の点字・DAISY図書ファイルを開く
- 複数巻（複数点字ファイル）に対応
...
**注意**:
- 複数巻に分かれた図書の場合、巻選択ダイアログが表示されます
- DAISY図書は自動的にブラウザで開きます
...
- DAISY 2.02（ncc.html形式）
- DAISY 3（DTBook形式）
- テキストDAISY

**DAISY閲覧について**: DAISYファイルはブラウザで開きます。目次と本文が表示され、NVDAの見出しジャンプ機能（H/Shift+H）でナビゲーションできます。
